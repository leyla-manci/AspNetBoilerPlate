...
export class ScreenServiceProxy {
     ...
     * @return Success
     */
    create(input: CreateScreenDto | null | undefined): Observable<ScreenDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ScreenDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ScreenDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<ScreenDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = ScreenDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ScreenDto>(<any>null);
    }
     ...
     * @return Success
     */
    getScreens(permission: string | null | undefined): Observable<ListResultDtoOfScreenListDto> {
        let url_ = this.baseUrl + "/api/services/app/Screen/GetScreensAsync?";
        if (permission !== undefined)
            url_ += "Permission=" + encodeURIComponent("" + permission) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetScreens(<any>response_);
                } catch (e) {
                    return <Observable<ListResultDtoOfScreenListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfScreenListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetScreens(response: HttpResponseBase): Observable<ListResultDtoOfScreenListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = ListResultDtoOfScreenListDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfScreenListDto>(<any>null);
    }
     ...
     * @return Success
     */
    update(input: ScreenDto | null | undefined): Observable<ScreenDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ScreenDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    getAllPermissions(): Observable<ListResultDtoOfPermissionDto> {
        let url_ = this.baseUrl + "/api/services/app/Screen/GetAllPermissions";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getScreenForEdit(id: number): Observable<GetScreenOutput> {
        let url_ = this.baseUrl + "/api/services/app/Screen/GetScreenForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            return this.processGetScreenForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetScreenForEdit(<any>response_);
                } catch (e) {
                    return <Observable<GetScreenOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetScreenOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetScreenForEdit(response: HttpResponseBase): Observable<GetScreenOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = GetScreenOutput.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetScreenOutput>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | null | undefined): Observable<ScreenDto> {
        let url_ = this.baseUrl + "/api/services/app/Screen/Get?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGet(response: HttpResponseBase): Observable<ScreenDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfScreenDto> {
        let url_ = this.baseUrl + "/api/services/app/Screen/GetScreensAsync?";
        if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        if (skipCount !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfScreenDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfScreenDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfScreenDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = PagedResultDtoOfScreenDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfScreenDto>(<any>null);
    }
}
...
export class CreateScreenDto implements ICreateScreenDto {
    name: string;

    constructor(data?: ICreateScreenDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateScreenDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateScreenDto();
        result.init(data);
        return result;
    }
...
export interface ICreateScreenDto {
    name: string;
}

export class ScreenDto implements IScreenDto {
    name: string;
    id: number | undefined;

    constructor(data?: IScreenDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ScreenDto {
        data = typeof data === 'object' ? data : {};
        let result = new ScreenDto();
        result.init(data);
        return result;
    }
...
export interface IScreenDto {
    name: string;
    id: number | undefined;
}

export class ListResultDtoOfScreenListDto implements IListResultDtoOfScreenListDto {
    items: ScreenListDto[] | undefined;

    constructor(data?: IListResultDtoOfScreenListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfScreenListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfScreenListDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfScreenListDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfScreenListDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfScreenListDto {
    items: ScreenListDto[] | undefined;
}
...
export class GetScreenOutput implements IGetScreenOutput {
    screen: ScreenEditDto | undefined;

    constructor(data?: IGetScreenOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.screen = data["screen"] ? ScreenEditDto.fromJS(data["screen"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetScreenOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetScreenOutput();
        result.init(data);
        return result;
    }
...
export interface IGetScreenOutput {
    screen: ScreenEditDto | undefined;
}

export class ScreenEditDto implements IScreenEditDto {
    name: string;
    id: number | undefined;

    constructor(data?: IScreenEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ScreenEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new ScreenEditDto();
        result.init(data);
        return result;
    }
...
export interface IScreenEditDto {
    name: string;
    id: number | undefined;
}

export class PagedResultDtoOfScreenDto implements IPagedResultDtoOfScreenDto {
    totalCount: number | undefined;
    items: ScreenDto[] | undefined;

    constructor(data?: IPagedResultDtoOfScreenDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items.push(ScreenDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfScreenDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfScreenDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfScreenDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfScreenDto();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfScreenDto {
    totalCount: number | undefined;
    items: ScreenDto[] | undefined;
}


export class ListResultDtoOfScreenDto implements IListResultDtoOfScreenDto {
    items: ScreenDto[] | undefined;

    constructor(data?: IListResultDtoOfScreenDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ListResultDtoOfScreenDto {
        data = typeof data === 'object' ? data : {};
        let result = new ListResultDtoOfScreenDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ListResultDtoOfScreenDto {
        const json = this.toJSON();
        let result = new ListResultDtoOfScreenDto();
        result.init(json);
        return result;
...
export interface IListResultDtoOfScreenDto {
    items: ScreenDto[] | undefined;
}
